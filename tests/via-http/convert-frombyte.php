...
$filesizes = array(
    ...
    20000000000001, 100000000000000, 3000000000000000, 10000000000000000, 100000000000000000, 1000000000000000000, 10000000000000000000,
...
echo '<strong>convert from bytes to KB unit</strong><br>';
foreach ($filesizes as $size) {
    echo $size.' = '.$number->fromBytes($size, 'KB').'<br>';
}
echo '<br>';

echo '<strong>convert from bytes to KiB unit</strong><br>';
foreach ($filesizes as $size) {
    echo $size.' = '.$number->fromBytes($size, 'KiB').'<br>';
}
echo '<br>';

echo '<strong>convert from bytes to GB unit</strong><br>';
foreach ($filesizes as $size) {
    echo $size.' = '.$number->fromBytes($size, 'GB').'<br>';
}
echo '<br>';

echo '<strong>convert from bytes to YB unit</strong><br>';
foreach ($filesizes as $size) {
    echo $size.' = '.$number->fromBytes($size, 'YB').'<br>';
}
echo '<br>';

echo '<strong>convert from bytes to ERROR unit</strong><br>';
foreach ($filesizes as $size) {
